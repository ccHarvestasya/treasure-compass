...
export const GRADE_CONFIG: GradeConfig[] = [
  { grade: 8,  label: 'G8',      jsonFile: '/json/g8.json',  imagePrefix: '/img/map_g8_'  },
  { grade: 10, label: 'G10',     jsonFile: '/json/g10.json', imagePrefix: '/img/map_g10_' },
  { grade: 12, label: 'G12',     jsonFile: '/json/g12.json', imagePrefix: '/img/map_g12_' },
  { grade: 14, label: 'G14/G15', jsonFile: '/json/g14.json', imagePrefix: '/img/map_g14_' },
  { grade: 17, label: 'G17/G18', jsonFile: '/json/g17.json', imagePrefix: '/img/map_g17_' },
