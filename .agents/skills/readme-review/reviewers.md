...
package / package manifest、repository、TypeScript 公開 API、browser bundle、build、公開境界 public docs、
...
未実装・future・deferred、環境・データ、署名、localStorage、入力データ handling、ブラウザ実行・build 境界 ownership、
license、migration、release status、security boundary、過剰保証を確認する。JA / EN または root /
package README 間で capability、制約、supported environment、public API、browser / build、公開境界、
